interface ListenerOptions {
    /**
     * A boolean value indicating whether the listener should be invoked at most once after being added.\
...
export class TabChannel<T> {
     ...
     * @param name - The name of the channel. The provided name will be used as the name of the `BroadcastChannel`.
     * @remarks Please be cautious when choosing a name to avoid conflicts with other BroadcastChannels.
